...
namespace DataAccessLayer.Interface
{
    public interface IDivisionDAL : IDisposable
    {
        ...
        Task<(GetDivisionModel? getClientDivisionModel,  List<DropDownModel?> getBusinessEntityDatatables, List<DropDownModel?> getCostCenterDivisionDatatables, List<DropDownModel?> getDepartmentDatatables)> GetClientDivisionByGUId(string GuId);
