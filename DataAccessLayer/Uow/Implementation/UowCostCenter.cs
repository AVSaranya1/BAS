...
{
    public class UowCostCenter: IUowCostCenter
    {
        ICostCenterDAL? objCostCenterDAL = null;
        IDbTransaction transaction;
        IDbConnection? connection = null;
        IHttpContextAccessor _httpContextAccessor;
        public UowCostCenter(string connectionstring, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public UowCostCenter(IHttpContextAccessor httpContextAccessor) : this(
       ...
       httpContextAccessor)
        ...
        public ICostCenterDAL CostCenterDALRepo
        {
            get
            {
                return objCostCenterDAL == null ? objCostCenterDAL = new CostCenterDAL(transaction) : objCostCenterDAL;
            }
        }
        public void Commit()
        {
