...
{
    public class UowClientRole : IUowClientRole
    {
        IClientRoleDAL? objRoleDAL = null;
        IDbTransaction transaction;
        IDbConnection? connection = null;
        private readonly IHttpContextAccessor _httpContextAccessor;
        // Existing constructor that accepts connection string and IHttpContextAccessor.
        public UowClientRole(string connectionstring, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public UowClientRole(IHttpContextAccessor httpContextAccessor) : this(
        ...
        public IClientRoleDAL RoleDALRepo
        {
            get
            {
                ...
                return objRoleDAL == null ? objRoleDAL = new ClientRoleDAL(httpContextAccessor, configuration) : objRoleDAL;
            }
        }
