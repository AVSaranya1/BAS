...
{
    public class UowDivision : IUowDivision
    {
        IDivisionDAL? objClientDivisionDAL = null;
        IDbTransaction transaction;
        IDbConnection? connection = null;
        IHttpContextAccessor _httpContextAccessor;

        public UowDivision(string connectionstring, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public UowDivision(IHttpContextAccessor httpContextAccessor) : this(
        ...
        public IDivisionDAL ClientDivisionDALRepo
        {
            get
            {
                return objClientDivisionDAL == null ? objClientDivisionDAL = new DivisionDAL (transaction) : objClientDivisionDAL;
            }
        }
