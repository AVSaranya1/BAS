...
{
    public class UowClientUserGroup: IUowClientUserGroup
    {
        IClientUserGroupDAL? objUserGroupDAL = null;
        IDbTransaction transaction;
        IDbConnection? connection = null;
        IHttpContextAccessor _httpContextAccessor;
        UowClientUserGroup(string connectionstring, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public UowClientUserGroup(IHttpContextAccessor httpContextAccessor) : this(
        ...
        public IClientUserGroupDAL UserGroupDALRepo
        {
            get
            {
                return objUserGroupDAL == null ? objUserGroupDAL = new ClientUserGroupDAL(transaction) : objUserGroupDAL;
            }
        }
        public void Commit()
        {
