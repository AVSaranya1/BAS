...
{
    public class UowClientUserAccount : IUowClientUser
    {
        IClientUserAccountDAL? objUserAccountDAL = null;
        IDbTransaction transaction;
        IDbConnection? connection = null;
        private readonly IHttpContextAccessor? _httpContextAccessor;
        private readonly IConfiguration _configuration;
        private readonly EncryptedDecrypt _encryptedDecrypt;
        public UowClientUserAccount(IHttpContextAccessor? httpContextAccessor) : this(
        ...
        public UowClientUserAccount(string? connectionString, IHttpContextAccessor? httpContextAccessor, IConfiguration? configuration)
        {
        ...
        public UowClientUserAccount(string? ConnectionString, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public IClientUserAccountDAL UserAccountDALRepo
        {
            get
            {
                // Manually create an HttpContextAccessor (if needed)
                IHttpContextAccessor httpContextAccessor = new HttpContextAccessor();
                IConfiguration _configuration = httpContextAccessor.HttpContext?.RequestServices.GetService<IConfiguration>()
                                                ?? throw new InvalidOperationException("Configuration service is not available.");

                return objUserAccountDAL ?? new ClientUserAccountDAL(httpContextAccessor, _configuration);
